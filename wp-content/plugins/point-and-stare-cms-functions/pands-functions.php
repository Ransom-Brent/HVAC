                       ...
                       <table class="pands-cms-options-table">
                            ...
                            <tr>
                              <td valign="top"><?php _e('Tools', 'pands'); ?></td>
                                ...
                                <td><input name="pands_script_plugin_options[privacy_submenu]" type="checkbox" value="1" <?php checked('1', isset($options['privacy_submenu'])); ?> /></td>
                            </tr>
                            <tr>
                    ...
                    <div id="tabs-pands-pages-posts">
                        ...
                        <table class="pands-cms-options-table">
                            ...
                            <tr>
                                ...
                                <td><?php _e('Comments', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[commentsdiv_page]" type="checkbox" value="1" <?php checked('1', isset($options['commentsdiv_page'])); ?> /></td>
                            </tr>
                            <tr>
...
//added 8.4.2012
    if (is_user_logged_in()) {
        $options = get_option('pands_script_plugin_options');
        if (isset($options['custom_admin_login_header_link']) == "") {
...
function google_verified_authorship() {
    $options = get_option('pands_script_plugin_options');
    if (isset($options['google_verified_authorship'])== "") {
        
    } else {
        echo '' . "\n" . '<link rel="author" href="https://plus.google.com/' . $options['google_verified_authorship'] . '/posts" />' . "\n" . '';
    }
}
...
if (!is_admin()) {
    ...
    if ($options['jquery_path'] != "")
        wp_register_script('jquery', ($options['jquery_path']), false, '1.3.8', true);
    else
...
function remove_submenus() {
    ...
    if (isset($options['privacy_submenu']) == 1)
