    ...
    <div class="wrap">
        <div id="heres-jonny"><h2>Point and Stare CMS Functions WordPress plugin</h2>
            ...
            <strong>Any issues, contact Point and Stare anytime:</strong><br />
                <a href="http://twitter.com/pointandstare" target="_blank"><img class="icon-twitter" src="https://dl.dropboxusercontent.com/u/19351261/socials/icon-twitter.svg"></a> <a href="https://plus.google.com/+PointandStareLtd" target="_blank"><img class="icon-gplus" src="https://dl.dropboxusercontent.com/u/19351261/socials/icon-googleplus.svg" alt="Point and Stare on google pages"></a></p>
                ...
                <div id="tabs-pands-script">
                    ...
                    <div id="tabs-pands-admin">
                        ...
                        <table class="pands-cms-options-table">
                            ...
                            <tr>
                                <td><?php _e('Login logo link', 'pands'); ?><br /><span class="th-small"><?php _e('Only change this if required - default is your site URL', 'pands'); ?></span></td>
                        ...
                        <table class="pands-cms-options-table">
                            ...
                            <tr>
                                <td title="<?php _e('Admin page title', 'pands'); ?>"><?php _e('Admin page title', 'pands'); ?><br /><span class="th-small"><?php _e('This plugin sets it to \'Control panel\'', 'pands'); ?></td>
                                <td><input class="ui-widget-text" name="pands_script_plugin_options[admin_title]" type="text" value="<?php echo $options['admin_title']; ?>" /></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><?php _e('Don\'t like \'Howdy\'?', 'pands'); ?> <small><?php _e('(top right)</small>', 'pands'); ?><br /><span class="th-small"><?php _e('Change it to something more \'local\'', 'pands'); ?>.</span></td>
                       ...
                       <table class="pands-cms-options-table">
                            ...
                            <tr>
                                ...
                                <td><input name="pands_script_plugin_options[available_tools_submenu]" type="checkbox" value="1" <?php checked('1', $options['available_tools_submenu']); ?> /></td>
                            </tr>
                             <tr>
                               ...
                               <td><input name="pands_script_plugin_options[customize_submenu]" type="checkbox" value="1" <?php checked('1', $options['customize_submenu']); ?> /></td>
                             </tr>
                             
                             <tr>
                               <td><?php _e('Media', 'pands'); ?></td>
                               <td><input name="pands_script_plugin_options[upload_menu_item]2" type="checkbox" value="1" <?php checked('1', $options['upload_menu_item']); ?> /></td>
                             ...
                             <tr>
                               ...
                               <td><input name="pands_script_plugin_options[edit_menu_item]2" type="checkbox" value="1" <?php checked('1', $options['edit_menu_item']); ?> /></td>
                               <td><?php _e('Export', 'pands'); ?></td>
                               <td><input name="pands_script_plugin_options[export_submenu]" type="checkbox" value="1" <?php checked('1', $options['export_submenu']); ?> /></td>
                             </tr>
                            <tr>
                              <td><?php _e('Plugins', 'pands'); ?></td>
                              <td><input name="pands_script_plugin_options[plugins_menu_item]2" type="checkbox" value="1" <?php checked('1', $options['plugins_menu_item']); ?> /></td>
                              <td><?php _e('General', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[general_submenu]" type="checkbox" value="1" <?php checked('1', $options['general_submenu']); ?> /></td>
                            </tr>
                            <tr>
                              <td><?php _e('Posts', 'pands'); ?></td>
                              <td><input name="pands_script_plugin_options[posts_menu_item]2" type="checkbox" value="1" <?php checked('1', $options['posts_menu_item']); ?> /></td>
                              <td><?php _e('Import', 'pands'); ?></td>
                              <td><input name="pands_script_plugin_options[import_submenu]" type="checkbox" value="1" <?php checked('1', $options['import_submenu']); ?> /></td>
                            </tr>
                            <tr>
                              ...
                              <td rowspan="4" valign="top"><input name="pands_script_plugin_options[options-general_menu_item]2" type="checkbox" value="1" <?php checked('1', $options['options-general_menu_item']); ?> /></td>
                              <td><?php _e('Media', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[media_submenu]" type="checkbox" value="1" <?php checked('1', $options['media_submenu']); ?> /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input name="pands_script_plugin_options[permalinks_submenu]" type="checkbox" value="1" <?php checked('1', $options['permalinks_submenu']); ?> /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td valign="top"><?php _e('Tools', 'pands'); ?></td>
                                <td valign="top"><input name="pands_script_plugin_options[tools_menu_item]2" type="checkbox" value="1" <?php checked('1', $options['tools_menu_item']); ?> /></td>
                                <td><?php _e('Privacy', 'pands'); ?></td>
                            ...
                            <tr>
                              <td><?php _e('Theme editor', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[theme_editor_submenu]" type="checkbox" value="1" <?php checked('1', $options['theme_editor_submenu']); ?> /></td>
                            </tr>
                            <tr>
                    ...
                    <div id="tabs-pands-dashboard">
                        <h3><?php _e('You can remove widgets and add your own panels using these options.', 'pands'); ?></h3>
                        <table class="pands-cms-options-table">
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><input name="pands_script_plugin_options[dashboard_activity]" type="checkbox" value="1" <?php checked('1', $options['dashboard_activity']); ?> /></td>
                            </tr>
                             <tr>
                                <td><?php _e('At a glance', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[dash-right-now]" type="checkbox" value="1" <?php checked('1', $options['dash-right-now']); ?> /></td>
                            </tr> 
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><input name="pands_script_plugin_options[welcome_panel]" type="checkbox" value="1" <?php checked('1', $options['welcome_panel']); ?> /></td>
                            </tr>
                            <tr>
                                                    ...
                                                    <td class="cms_panel_container">
                                                        ...
                                                        <table class="panel_table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php wp_editor($panel['content'], 'pands_script_plugin_options[dashboard_panels][' . $id . '][content]') ?>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <hr />
                    ...
                    <div id="tabs-pands-pages-posts">
                        ...
                        <table class="pands-cms-options-table">
                            ...
                            <tr>
                                <th colspan="5"><strong><?php _e('For Posts and Pages', 'pands'); ?></strong></th>
                            </tr>
                            <tr>
                                <td><?php _e('Remove screen option tab', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[remove_screen_options_tab]" type="checkbox" value="1" <?php checked('1', $options['remove_screen_options_tab']); ?> /></td>
                                <td>&nbsp;</td>
                                <td><?php _e('Remove help tab', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[hide_help_tab]" type="checkbox" value="1" <?php checked('1', $options['hide_help_tab']); ?> /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php _e('Comments', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[commentsdiv_post]" type="checkbox" value="1" <?php checked('1', $options['commentsdiv_post']); ?> /></td>
                                <td><?php _e('Comments', 'pands'); ?></td>
                            ...
                            <tr>
                               <td><?php _e('Custom Fields', 'pands'); ?></td>
                                ...
                                <td><?php _e('Discussion', 'pands'); ?></td>
                                <td><input class="checkbox" name="pands_script_plugin_options[discussiondiv_page]" type="checkbox" value="1" <?php checked('1', $options['discussiondiv_page']); ?> /></td>
                            </tr>
                            <tr>
                              <td><?php _e('Discussion', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[discussiondiv_post]" type="checkbox" value="1" <?php checked('1', $options['discussiondiv_post']); ?> /></td>
                                
                                 <td><?php _e('Featured image', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[postimagediv_page]" type="checkbox" value="1" <?php checked('1', $options['postimagediv_page']); ?> /></td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                               <td><?php _e('Featured image', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[postimagediv_post]" type="checkbox" value="1" <?php checked('1', $options['postimagediv_post']); ?> /></td>
                            ...
                            <tr>
                             ...
                             <tr>
                              <td><?php _e('Publish', 'pands'); ?></td>
                                ...
                                <td><input name="pands_script_plugin_options[slugdiv_page]" type="checkbox" value="1" <?php checked('1', $options['slugdiv_page']); ?> /></td>
                            </tr>                           
                            <tr>
                              <td><?php _e('Revisions', 'pands'); ?></td>
                            ...
                            <tr><td><?php _e('Slug', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[slugdiv_post]" type="checkbox" value="1" <?php checked('1', $options['slugdiv_post']); ?> /></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                             <tr>
                                <td colspan="4"><?php _e('Revisions - (in publish panel both posts and pages)', 'pands'); ?></td>
                                <td><input name="pands_script_plugin_options[revisionsdiv_panel]" type="checkbox" value="1" <?php checked('1', $options['revisionsdiv_panel']); ?> /></td>
                    ...
                    <div id="tabs-pands-front-end">
                        ...
                        <table class="pands-cms-options-table">
                            ...
                            <tr>
                                ...
                                <td><input name="pands_script_plugin_options[maintenance_mode]" type="checkbox" value="1" <?php checked('1', $options['maintenance_mode']); ?> /></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><input name="pands_script_plugin_options[remove_admin_bar]" type="checkbox" value="1" <?php checked('1', $options['remove_admin_bar']); ?> /></td>
                            </tr>
                            <tr>
                                <td>
                                    Site wide favicon
                        ...
                        <table class="pands-cms-options-table">
                            ...
                            <tr>
                                ...
                                <td><input name="pands_script_plugin_options[remove_site_feed_links]" type="checkbox" value="1" <?php checked('1', $options['remove_site_feed_links']); ?> /></td>
                            </tr>
                            <tr>
                                <td>Remove comments RSS feeds</td>
                                <td><input name="pands_script_plugin_options[remove_comments_feed_links]" type="checkbox" value="1" <?php checked('1', $options['remove_comments_feed_links']); ?> /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>JQuery Path<br /><span class="th-small">Add the absolute path of your prefered JQuery file.<br />Defaults to jQuery JavaScript Library v1.7.2 from Google CDN</span></td>
                        ...
                        <table class="pands-cms-options-table">
                            <tr>
                                <td class="panel-title" colspan="2">Add Google Verified Authorship</td>
                            </tr>
                            <tr>
                                <td>Add Google Verified Authorship<br /><span class="th-small">Just add the profile ID here - for example, mine is <a href="https://plus.google.com/105475484427213195749/posts" title="Lee Rickler's Google+ profile" target="_blank">105475484427213195749</a> or if you have a vanity URL - <a href="https://plus.google.com/+LeeRickler/posts" title="Lee Rickler's Google+ profile" target="_blank">+LeeRickler</a>.<br />After you have added the author's G+ ID, you need to go to your Google+ profile, and add a link to this website under the contributors section.</span></td>
                                <td><input name="pands_script_plugin_options[google_verified_authorship]" type="text" value="<?php echo $options['google_verified_authorship']; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                </div>
...
function pands_admin_enqueue_scripts() {
    ...
    wp_register_style('cms_admin_options_style', plugin_dir_url(__FILE__) . 'css/cms_admin_options_style.css.php', false);
    wp_enqueue_style('cms_admin_options_style');
}
...
// ADD GOOGLE VERIFIED AUTHORSHIP
function google_verified_authorship() {
    $options = get_option('pands_script_plugin_options');
    if ($options['google_verified_authorship'] == "") {
        
    } else {
        echo '<link rel="author" href="https://plus.google.com/' . $options['google_verified_authorship'] . '/posts" />';
    }
}

add_action('wp_head', 'google_verified_authorship');
...
if (!is_admin()) {
    ...
    if ($options['jquery_path'] != "")
        ...
        wp_register_script('jquery', ("https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.js"), true);
    wp_enqueue_script('jquery');
}
...
if ($options['remove_screen_options_tab'] == 1)
...
function pands_remove_boxes() {
    ...
    if ($options['commentsdiv_post'] == 1)
        remove_meta_box('commentsdiv', 'post', 'normal');
    if ($options['discussiondiv_post'] == 1)
        remove_meta_box('commentstatusdiv', 'post', 'normal');
   if ($options['revisionsdiv_post'] == 1)
       remove_meta_box('revisionsdiv', 'post', 'normal');
    if ($options['slugdiv_post'] == 1)
    ...
    if ($options['discussiondiv_page'] == 1)
        remove_meta_box('commentstatusdiv', 'page', 'normal');
    if ($options['revisionsdiv_page'] == 1)
        remove_meta_box('revisionsdiv', 'page', 'normal');
    if ($options['slugdiv_page'] == 1)
...
function remove_thumbnail_box() {
  $options = get_option('pands_script_plugin_options');
    if ($options['postimagediv_post'] == 1)
      remove_meta_box( 'postimagediv','post','side' );

    if ($options['postimagediv_page'] == 1)
...
function disable_default_dashboard_widgets() {
    $options = get_option('pands_script_plugin_options');
    if ($options['dashboard_activity'] == 1)
        remove_meta_box('dashboard_activity', 'dashboard', 'core');
    if ($options['dashboard_quick_press'] == 1)
        remove_meta_box('dashboard_quick_press', 'dashboard', 'core');
    if ($options['dash-right-now'] == 1)
        remove_meta_box('dashboard_right_now', 'dashboard', 'core');
    if ($options['welcome_panel'] == 1)
...
function remove_submenus() {
    ...
    if ($options['media_submenu'] == 1)
        unset($submenu['options-general.php'][30]); // Removes 'Media'
    if ($options['general_submenu'] == 1)
...
function remove_editor_menu() {
    $options = get_option('pands_script_plugin_options');
    if ($options['theme_editor_submenu'] == 1) {
...
if ($options['remove_site_feed_links'] == 1)
    remove_action('wp_head', 'feed_links', 2);
if ($options['remove_comments_feed_links'] == 1)
